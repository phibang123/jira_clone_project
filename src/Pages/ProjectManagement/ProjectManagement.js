											...
											(
												<tr key={index}>
													...
													<td>
														...
														}} style={{borderRadius: '50%',lineHeight: '50%'}} className='btn btn-outline-danger'><DeleteOutlined /></button>
													</td>
												</tr>
											))}
										</tbody>
			...
			render: (text, record, index) => (
				<div size="middle">
					...
					<Popconfirm
						...
						cancelText="No"
					>
						<button style={{lineHeight: '50%'}} className="btn mr-2 btn-outline-danger">
